...
class SmartyPants(Plugin):
	...
	def _message_PLUGIN_REGISTER(self, message):
		...
		set_dir = PluginTextEvent(FACT_SET, IRCT_PUBLIC_D, SET_RE, exclusive=1)
		set_msg = PluginTextEvent(FACT_SET, IRCT_MSG, SET_RE, exclusive=1)
		set_pub = PluginTextEvent(FACT_SET, IRCT_PUBLIC, SET_RE, exclusive=1)
